                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <a href="ui-offcanvas.html" class="dropdown-item"
                                        key="t-offcanvas">Offcanvas</a>
                                    <a href="ui-rangeslider.html" class="dropdown-item"
                                        key="t-range-slider">Range Slider</a>
                                    <a href="ui-session-timeout.html" class="dropdown-item"
                                        key="t-session-timeout">Session Timeout</a>
                                    <a href="ui-progressbars.html" class="dropdown-item"
                                        key="t-progress-bars">Progress Bars</a>
                                    <a href="ui-placeholders.html" class="dropdown-item"
                                        key="t-placeholders">Placeholders</a>
                                    <a href="ui-sweet-alert.html" class="dropdown-item"
                                        key="t-sweet-alert">Sweet-Alert</a>
                                    <a href="ui-tabs-accordions.html" class="dropdown-item"
                                        key="t-tabs-accordions">Tabs & Accordions</a>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div>
                    ...
                    <div class="dropdown-menu" aria-labelledby="topnav-pages">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-email">
                                <a href="calendar.html" class="dropdown-item" key="t-tui-calendar">TUI
                                    Calendar</a>
                                <a href="calendar-full.html" class="dropdown-item"
                                    key="t-full-calender">Full Calendar</a>
                            </div>
                        </div>

                        <a href="chat.html" class="dropdown-item" key="t-chat">Chat</a>
                        <a href="apps-filemanager.html" class="dropdown-item" key="t-file-manager">File
                            Manager</a>
                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                id="topnav-email" role="button">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-email">
                                ...
                                <a href="email-read.html" class="dropdown-item" key="t-read-email">Read
                                    Email</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-blog">
                                        <a href="email-template-basic.html" class="dropdown-item"
                                            key="t-basic-action">Basic Action</a>
                                        <a href="email-template-alert.html" class="dropdown-item"
                                            key="t-alert-email">Alert Email</a>
                                        <a href="email-template-billing.html" class="dropdown-item"
                                            key="t-bill-email">Billing Email</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                ...
                                <a href="ecommerce-product-detail.html" class="dropdown-item"
                                    key="t-product-detail">Product Detail</a>
                                ...
                                <a href="ecommerce-add-product.html" class="dropdown-item"
                                    key="t-add-product">Add Product</a>
                            </div>
                        </div>

                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                id="topnav-crypto" role="button">
                                <span key="t-crypto">Crypto</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-crypto">
                                <a href="crypto-wallet.html" class="dropdown-item"
                                    key="t-wallet">Wallet</a>
                                <a href="crypto-buy-sell.html" class="dropdown-item"
                                    key="t-buy">Buy/Sell</a>
                                <a href="crypto-exchange.html" class="dropdown-item"
                                    key="t-exchange">Exchange</a>
                                <a href="crypto-lending.html" class="dropdown-item"
                                    key="t-lending">Lending</a>
                                <a href="crypto-orders.html" class="dropdown-item"
                                    key="t-orders">Orders</a>
                                <a href="crypto-kyc-application.html" class="dropdown-item"
                                    key="t-kyc">KYC Application</a>
                                <a href="crypto-ico-landing.html" class="dropdown-item"
                                    key="t-ico">ICO Landing</a>
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-project">
                                <a href="projects-grid.html" class="dropdown-item"
                                    key="t-p-grid">Projects Grid</a>
                                <a href="projects-list.html" class="dropdown-item"
                                    key="t-p-list">Projects List</a>
                                <a href="projects-overview.html" class="dropdown-item"
                                    key="t-p-overview">Project Overview</a>
                                <a href="projects-create.html" class="dropdown-item"
                                    key="t-create-new">Create New</a>
                            </div>
                        </div>
                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                id="topnav-task" role="button">
                                <span key="t-tasks">Tasks</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-task">
                                <a href="tasks-list.html" class="dropdown-item" key="t-task-list">Task
                                    List</a>
                                <a href="tasks-kanban.html" class="dropdown-item"
                                    key="t-kanban-board">Kanban Board</a>
                                <a href="tasks-create.html" class="dropdown-item"
                                    key="t-create-task">Create Task</a>
                            </div>
                        </div>
                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                <a href="contacts-grid.html" class="dropdown-item" key="t-user-grid">User
                                    Grid</a>
                                <a href="contacts-list.html" class="dropdown-item" key="t-user-list">User
                                    List</a>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-blog">
                                <a href="blog-list.html" class="dropdown-item" key="t-blog-list">Blog
                                    List</a>
                                <a href="blog-grid.html" class="dropdown-item" key="t-blog-grid">Blog
                                    Grid</a>
                                <a href="blog-details.html" class="dropdown-item"
                                    key="t-blog-details">Blog Details</a>
                            </div>
                        </div>

                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                id="topnav-jobs" role="button">
                                <span key="t-jobs">Jobs</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-jobs">
                                <a href="job-list.html" class="dropdown-item" key="t-job-list">Job
                                    List</a>
                                <a href="job-grid.html" class="dropdown-item" key="t-job-grid">Job
                                    Grid</a>
                                <a href="job-apply.html" class="dropdown-item" key="t-apply-job">Apply
                                    Job</a>
                                <a href="job-details.html" class="dropdown-item" key="t-job-details">Job
                                    Details</a>
                                <a href="job-categories.html" class="dropdown-item"
                                    key="t-Jobs-categories">Jobs Categories</a>
                                <div class="dropdown">
                                    <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-candidate">
                                        <a href="candidate-list.html" class="dropdown-item"
                                            key="t-list">List</a>
                                        <a href="candidate-overview.html" class="dropdown-item"
                                            key="t-overview">Overview</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="dropdown-menu" aria-labelledby="topnav-components">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-form">
                                <a href="form-elements.html" class="dropdown-item"
                                    key="t-form-elements">Form Elements</a>
                                <a href="form-layouts.html" class="dropdown-item"
                                    key="t-form-layouts">Form Layouts</a>
                                <a href="form-validation.html" class="dropdown-item"
                                    key="t-form-validation">Form Validation</a>
                                <a href="form-advanced.html" class="dropdown-item"
                                    key="t-form-advanced">Form Advanced</a>
                                <a href="form-editors.html" class="dropdown-item"
                                    key="t-form-editors">Form Editors</a>
                                <a href="form-uploads.html" class="dropdown-item"
                                    key="t-form-upload">Form File Upload</a>
                                <a href="form-xeditable.html" class="dropdown-item"
                                    key="t-form-xeditable">Form Xeditable</a>
                                <a href="form-repeater.html" class="dropdown-item"
                                    key="t-form-repeater">Form Repeater</a>
                                <a href="form-wizard.html" class="dropdown-item" key="t-form-wizard">Form
                                    Wizard</a>
                                <a href="form-mask.html" class="dropdown-item" key="t-form-mask">Form
                                    Mask</a>
                            </div>
                        </div>
                        <div class="dropdown">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                <a href="charts-apex.html" class="dropdown-item" key="t-apex-charts">Apex
                                    charts</a>
                                <a href="charts-echart.html" class="dropdown-item" key="t-e-charts">E
                                    charts</a>
                                <a href="charts-chartjs.html" class="dropdown-item"
                                    key="t-chartjs-charts">Chartjs Charts</a>
                                <a href="charts-flot.html" class="dropdown-item" key="t-flot-charts">Flot
                                    Charts</a>
                                <a href="charts-tui.html" class="dropdown-item" key="t-ui-charts">Toast
                                    UI Charts</a>
                                <a href="charts-knob.html" class="dropdown-item"
                                    key="t-knob-charts">Jquery Knob Charts</a>
                                <a href="charts-sparkline.html" class="dropdown-item"
                                    key="t-sparkline-charts">Sparkline Charts</a>
                            </div>
                        </div>
                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                ...
                                <a href="icons-materialdesign.html" class="dropdown-item"
                                    key="t-material-design">Material Design</a>
                                ...
                                <a href="icons-fontawesome.html" class="dropdown-item"
                                    key="t-font-awesome">Font awesome</a>
                            </div>
                        </div>
                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-map">
                                <a href="maps-google.html" class="dropdown-item" key="t-g-maps">Google
                                    Maps</a>
                                <a href="maps-vector.html" class="dropdown-item" key="t-v-maps">Vector
                                    Maps</a>
                                <a href="maps-leaflet.html" class="dropdown-item" key="t-l-maps">Leaflet
                                    Maps</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                <a href="invoices-list.html" class="dropdown-item"
                                    key="t-invoice-list">Invoice List</a>
                                <a href="invoices-detail.html" class="dropdown-item"
                                    key="t-invoice-detail">Invoice Detail</a>
                            </div>
                        </div>
                        <div class="dropdown">
                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                ...
                                <a href="auth-email-verification-2.html" class="dropdown-item"
                                ...
                                <a href="auth-two-step-verification-2.html" class="dropdown-item"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                <a href="pages-starter.html" class="dropdown-item"
                                    key="t-starter-page">Starter Page</a>
                                ...
                                <a href="pages-comingsoon.html" class="dropdown-item"
                                    key="t-coming-soon">Coming Soon</a>
                                ...
                                <a href="pages-404.html" class="dropdown-item" key="t-error-404">Error
                                    404</a>
                                <a href="pages-500.html" class="dropdown-item" key="t-error-500">Error
                                    500</a>
                            </div>
                        </div>
                    </div>
