    ...
    @push('plugin')
        ...
        <script>
            $(document).ready(function() {
                function updateDateTime(group) {
                    var date = group.find('.start-date, .end-date').val();
                    var time = group.find('.start-time, .end-time').val();
                    if (date && time) {
                        var datetime = date + ' ' + time + ':00';
                        group.find('.start-at, .end-at').val(datetime).trigger('input');
                    }
                }
                ...
                $('.date-time-group').each(function() {
                    ...
                    group.find('.start-date, .end-date').datepicker({
                        format: 'yyyy-mm-dd',
                        autoclose: true
                    ...
                    group.find('.start-time, .end-time').timepicker({
                        showMeridian: false,
                        defaultTime: 'current',
                        appendWidgetTo: group,
